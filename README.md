...
```
sudo apt-get install git -y && apt-get install dos2unix -y && git clone --branch main https://github.com/uhangkayo/Lempzy.git && cd Lempzy && chmod +x lempzy-setup.sh && sudo ./lempzy-setup.sh
